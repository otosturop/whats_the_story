class LikePostsModel {
  ...
  LikePostsModel({this.status, this.data});

  LikePostsModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
...
class Data {
  ...
  Data({this.id, this.title, this.imageUrl, this.fullname, this.avatarUrl, this.post, this.subject, this.date});
